            ...
            <div className="max-w-[1280px] mx-auto px-4 md:px-8 xl:px-4 py-3 border-b border-gray-200">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-grow flex items-center gap-3">
                        <form className="flex-grow flex items-center border border-gray-400 rounded-full h-11 hover:border-gray-600 focus-within:border-black transition-colors" action="/search" method="get">
                            <div className="flex-grow flex items-center px-4 h-full gap-2">
                                ...
                                <input
                                    type="text"
                                    name="q"
                                    className="flex-grow bg-transparent outline-none text-[15px] placeholder-gray-500"
                                    placeholder="Search for anything"
                                />
                                <div className="h-full border-l border-gray-300 mx-2 hidden md:block"></div>
                                <select className="hidden md:block bg-transparent outline-none text-[13px] text-[#555] cursor-pointer pr-4 hover:text-blue-600">
                                    <option>All Categories</option>
                                </select>
                            </div>
                        </form>
                        <button className="bg-[#3665f3] hover:bg-[#3055CB] text-white h-11 px-12 rounded-full font-bold text-[15px] transition-colors border-none cursor-pointer">
                            Search
                        </button>
                        <Link to="/advanced" className="text-[11px] text-[#707070] hover:text-blue-600 transition-colors">
                            Advanced
                        </Link>
                    </div>
                </div>
