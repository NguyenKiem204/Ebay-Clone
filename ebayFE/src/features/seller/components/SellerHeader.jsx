                ...
                <nav className="flex items-center gap-8 text-sm font-medium">
                    {SELLER_NAV_ITEMS.map((item) => (
                        <Link
                            key={item.path}
                            to={item.path}
                            className={`py-3 border-b-4 transition-colors ${(item.path === '/seller' ? location.pathname === '/seller' : location.pathname.startsWith(item.path))
